"""Tests for the decision maker module.

Tests the DecisionMaker's ability to make intelligent infrastructure decisions.
"""

import pytest

from capabilities.databricks import DecisionMaker, InfrastructureRequest
